  ...
  _createClass(Form, [{
    ...
    value: function getStateFromProps(props) {
      ...
      var _ref = mustValidate ? this.validate(formData, schema) : {
        errors: props.errorSchema ? (0, _validate.toErrorList)(props.errorSchema) : state.errors || [],
    ...
    value: function validate(formData, schema) {
      ...
      var _validateFormData = (0, _validate2.default)(formData, schema || this.props.schema, validate, transformErrors),
