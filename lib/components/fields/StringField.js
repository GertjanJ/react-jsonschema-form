...
function StringField(props) {
  var schema = props.schema,
      ...
      rest = _objectWithoutProperties(props, ["schema", "name", "uiSchema", "idSchema", "formData", "required", "disabled", "readonly", "autofocus", "onChange", "onBlur", "onFocus", "registry", "rawErrors"]);
