  ...
  _createClass(ObjectField, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ["uiSchema", "formData", "errorSchema", "idSchema", "name", "required", "disabled", "readonly", "idPrefix", "onBlur", "onFocus", "registry"]);
      ...
      var templateProps = {
        ...
        properties: orderedProperties.map(function (name) {
          return {
            content: _react2.default.createElement(SchemaField, _extends({
              key: name,
              name: name,
